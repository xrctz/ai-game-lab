/**
 * AI Game Lab v7 — Service Worker
 * HTML uses network-first so GitHub Pages updates show quickly.
 * Static assets use cache-first with background refresh.
 */
const CACHE_HUB = 'ai-game-lab-hub-v7-revamp';
const CACHE_GAMES = 'ai-game-lab-games-v7-revamp';
const HUB_SHELL = [
  '/ai-game-lab/',
  '/ai-game-lab/index.html',
  '/ai-game-lab/styles.css?v=7',
  '/ai-game-lab/script.js?v=7',
  ...
  '/ai-game-lab/showcase/brand-mark.svg?v=7',
  '/ai-game-lab/showcase/favicon.svg?v=7'
];
